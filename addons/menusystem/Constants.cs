...
{
    public const string BASE_PATH = "res://addons/menusystem/";
    public const string MENU_EMPTY_PATH = "res://addons/menusystem/EmptyMenu.tscn";

    public const string NODE_BUTTON = "Button";
